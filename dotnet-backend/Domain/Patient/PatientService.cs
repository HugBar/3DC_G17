       ...
       public async Task SendMedicalHistoryRequestEmailAsync(string email)
{
    ...
    string downloadLink = $"https://localhost:5001/api/patient/medical-history/download-file/{encodedEmail}";

    string subject = "Medical History Download Request";
    string body = $@"Dear {patient.FirstName} {patient.LastName},

    We received a request to download your medical history. Click the link below to download your records:
    ...
    public async Task<byte[]> GenerateMedicalHistoryPdfAsync(string email)
{
    ...
    <body>
        <div class='header'>
            ...
            <p>Generated on {DateTime.Now:dd/MM/yyyy}</p>
        </div>

        <div class='section'>
            <h2>Patient Information</h2>
            <p><span class='label'>Name:</span> {patient.FirstName} {patient.LastName}</p>
            <p><span class='label'>Medical Number:</span> {patient.MedicalNr}</p>
            <p><span class='label'>Date of Birth:</span> {patient.DateofBirth:dd/MM/yyyy}</p>
        ...
        <div class='section'>
            ...
            <p><span class='label'>Emergency Contact:</span> {patient.EmergencyContact}</p>
        </div>
        ...
        <div class='section'>
            ...
            <p>{(patient.AppointmentHistory != null && patient.AppointmentHistory.Any() 
                ? string.Join("<br>", patient.AppointmentHistory)
                : "No appointment history recorded.")}</p>
        </div>

        <div class='footer'>
            <p>Generated by Healthcare System</p>
